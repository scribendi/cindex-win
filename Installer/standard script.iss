...
AppId=2D205939-269E-45B2-9894-7620B89319DC
AppName={#MyAppName}
AppMutex=CindexMutex
...
[Files]
Source: "inno\Standard\Cindex.exe"; DestDir: "{app}"; Flags: ignoreversion
...
; following needed for icu (later versions won't need it
;Source: "inno\msvcr100.dll"; DestDir: "{app}"; Flags: ignoreversion
;Source: "inno\msvcp100.dll"; DestDir: "{app}"; Flags: ignoreversion
...
;Root: HKLM; Subkey: "SOFTWARE\Indexing Research\Cindex\4.0"; ValueType: string; ValueName:"Owner"; ValueData: "Beta User"; Flags: uninsdeletekey
;Root: HKLM; Subkey: "SOFTWARE\Indexing Research\Cindex\4.0"; ValueType: string; ValueName:"Company"; ValueData: "Indexing Research"; Flags: uninsdeletekey
