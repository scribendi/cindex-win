...
AllowNoIcons=yes
OutputBaseFilename=CindexDebugSetup
Compression=lzma
...
[Files]
Source: "inno\Debug\Cindex.exe"; DestDir: "{app}"; Flags: ignoreversion
;Source: "inno\Debug\readme.rtf"; DestDir: "{app}"; Flags: ignoreversion isreadme
