...
AppId=5E9F23FA-2B16-460F-9BEC-7933E7E65A6A
AppName={#MyAppName}
...
AllowNoIcons=yes
OutputBaseFilename=CindexDemoSetup
Compression=lzma
...
[Files]
Source: "inno\Demo\Cindex.exe"; DestDir: "{app}"; Flags: ignoreversion
